...
namespace SmartLogger.Tests
{
    ...
    public class LoggerTests
    {
        ...
        {
            // Act
            Logger.Log("Verbose message", LogLevel.Verbose);
            Logger.Log("Important message", LogLevel.Important);
        ...
        {
            // Act
            Logger.LogIf(true, "Condition is true");
        ...
        {
            // Act
            Logger.LogIf(false, "Condition is false");
        ...
        {
            // Act
            Logger.LogFormat("Player {0} scored {1} points", "John", 100);
        ...
        public void IsLoggingEnabled_ReturnsExpectedValue()
        {
            ...
            Assert.That(Logger.IsLoggingEnabled, Is.TypeOf<bool>());
        }
        ...
        {
            // Act & Assert
            Assert.That(Logger.CurrentLogLevel, Is.TypeOf<LogLevel>());
        }
        ...
        {
            // Arrange
            Logger.Log("Test message to populate cache");

            // Act & Assert
            Assert.DoesNotThrow(() => Logger.ClearCache());
        }
        ...
        public void Log_WithVeryLongMessage_HandlesGracefully()
        {
            ...
            // Act & Assert
            Assert.DoesNotThrow(() => Logger.Log(longMessage));
            Assert.That(_logMessages.Count, Is.EqualTo(1));
        }
    ...
    public class SmartLoggerIntegrationTests
    {
        ...
        public void SmartLogger_WorksWithUnityObjects()
        {
            ...
            Assert.DoesNotThrow(() => 
            {
                Logger.Log($"Created GameObject: {gameObject.name}");
                Logger.LogWarning($"GameObject active: {gameObject.activeInHierarchy}");
            });
        ...
        public void SmartLogger_ThreadSafety_BasicTest()
        {
            ...
            for (int i = 0; i < taskCount; i++)
            {
                ...
                var task = System.Threading.Tasks.Task.Run(() =>
                {
                    ...
                    {
                        Logger.Log($"Task {taskId}, Message {j}");
                    }
                });
                tasks.Add(task);
            }
