...
namespace SmartLogger
{
    public static class Logger
    {
        ...
        /// <param name="logLevel">Importance level of the message</param>
        ...
        /// <param name="logLevel">Importance level</param>
        /// <param name="callerMemberName">Automatically filled by compiler</param>
        /// <param name="callerFilePath">Automatically filled by compiler</param>
        /// <param name="callerLineNumber">Automatically filled by compiler</param>
            ...
            [CallerLineNumber] int callerLineNumber = 0)
        {
            if (condition)
            {
                Log(messageText, logLevel, callerMemberName, callerFilePath, callerLineNumber);
            }
        }
        ...
        {
            return IsDevelopmentModeEnabled && LoggerConfig.Instance.LogDisplayLevel <= logLevel;
        }
        ...
        {
            var callerInfoCacheKey = $"{memberName}:{Path.GetFileName(filePath)}:{lineNumber}";
            
            return CallerDataCache.GetOrAdd(callerInfoCacheKey, _ =>
            {
